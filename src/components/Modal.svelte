<script>
    ...
    $: errorEmpty = start == 0 || end == 0;
    $: errorEqual = start != 0 && start == end;
    $: errorInverted = end < start;
    ...
    /** @type {string} */
    let errorMsg = "";
    function errorMessage(errorEmpty, errorEqual, errorInverted) {
        if (errorEmpty) {
        ...
        <div
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    ...
                    <div
                        class="mt-3 text-center sm:mt-0 md:mx-4 sm:text-left w-full">
                        <h3
