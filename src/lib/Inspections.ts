...
/** @type {(simpleReport: Inspections, periods: Periods) => Inspections} */
...
/** @type {(simpleReport: Inspections, ogPeriod: Period) => Inspections} */
...
/** @type {(inspections: Inspections, periods: Periods) => Inspections} */
export function makeReport(inspections, periods) {
    let report = [];
